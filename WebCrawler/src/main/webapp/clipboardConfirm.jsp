	...
	<table class="table">
	  <tbody>
			...
			<div class="tab-pane fade" id="nav-${info.seq }" role="tabpanel" aria-labelledby="nav-home-tab">
			     <div style="margin:auto;">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" name="link" value="user" class="form-control" id="inputLink" readOnly>
				  </div>
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <input type="text" name="cssQuery" value="user" class="form-control" id="inputCssQuery" readOnly>
				    </div>
				  </div>
				</div>
			</div>
		...
		<tr>
			...
			%>
			<div class="tab-pane fade" id="nav-<%=info.getSeq() %>0" role="tabpanel" aria-labelledby="nav-home-tab">
			     <table class="table">
				  <tbody>
